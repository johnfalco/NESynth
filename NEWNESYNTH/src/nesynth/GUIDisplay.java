...
public class GUIDisplay extends JFrame implements GUIConstants, SynthFrameUI {
...
/** Custom drawn JPanel */
    protected GUIFacePanel guiFacePanel;
...
/** Constructs the GUIDisplay
  */
    public GUIDisplay() {
        this.guiKeyPositionList = new KeyPositionList('A');
        this.guiLoader =
            new JFileChooser(new File(System.getProperty("user.dir")));
        this.setSize(SIZE[0], SIZE[1]);
        this.setTitle("NESynth");
        this.setLayout(new BorderLayout());
        this.guiFacePanel = new GUIFacePanel(1, this);
        this.add(this.guiFacePanel, BorderLayout.CENTER);
        this.guiFacePanel.setPreferredSize(new Dimension(625, 616));
        guiSynth = new SynthOne(this.guiFacePanel, 30);
        ...
        guiSynth.addSynthPanelUI(this.guiFacePanel);
        ...
        this.validate();
        bindKeys();
//         this.guiFacePanel.addMouseListener(guiNoteListen);
//         this.guiFacePanel.addKeyListener(guiNoteListen);
            ...
            if (action.equals(MENU[0])) {
                ...
                if (choice != null) {
                    if (choice.charAt(0) == 'L') {
                        ...
                        guiSynth.cleanActions();
                        guiFacePanel.toggleChannelBindingMode();
                    }
                } else {
