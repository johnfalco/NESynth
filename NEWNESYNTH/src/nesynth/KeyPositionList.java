...
/** Default construtor for the KeyPositionList
  */
    ...
    private void buildDefault(char bnk) {
        System.err.println("Creating default list");
        setLeftKeyboard(bnk);
        setPercAuxiliary(bnk);
        setRightKeyboard(bnk);
        setSynthSystem(bnk);
        setSequence(bnk);
    }
  ...
  */
    private void setSmall(char bnk) {
        this.add(new KeyPosition(bnk, 1 , CF, 76 , 27 , 
            new Rectangle(76 , 27 , 29 , 29), KeyEvent.VK_ESCAPE, null));
        this.add(new KeyPosition(bnk, 2 , CF, 139, 27 , 
            new Rectangle(139, 27 , 29 , 29), KeyEvent.VK_F1, null));
        this.add(new KeyPosition(bnk, 3 , CF, 170, 27 , 
            new Rectangle(170, 27 , 29 , 29), KeyEvent.VK_F2, null));
        this.add(new KeyPosition(bnk, 4 , CF, 201, 27 , 
            new Rectangle(201, 27 , 29 , 29), KeyEvent.VK_F3, null));
        this.add(new KeyPosition(bnk, 5 , CF, 232, 27 , 
            new Rectangle(232, 27 , 29 , 29), KeyEvent.VK_F4, null));
        this.add(new KeyPosition(bnk, 6 , CF, 279, 27 , 
            new Rectangle(279, 27 , 29 , 29), KeyEvent.VK_F5, null));
        this.add(new KeyPosition(bnk, 7 , CF, 310, 27 , 
            new Rectangle(310, 27 , 29 , 29), KeyEvent.VK_F6, null));
        this.add(new KeyPosition(bnk, 8 , CF, 341, 27 , 
            new Rectangle(341, 27 , 29 , 29), KeyEvent.VK_F7, null));
        this.add(new KeyPosition(bnk, 9 , CF, 372, 27 , 
            new Rectangle(372, 27 , 29 , 29), KeyEvent.VK_F8, null));
        this.add(new KeyPosition(bnk, 10, CF, 417, 27 , 
            new Rectangle(417, 27 , 29 , 29), KeyEvent.VK_F9, null));
        this.add(new KeyPosition(bnk, 11, CF, 448, 27 , 
            new Rectangle(448, 27 , 29 , 29), KeyEvent.VK_F10, null));
        this.add(new KeyPosition(bnk, 12, CF, 479, 27 , 
            new Rectangle(479, 27 , 29 , 29), KeyEvent.VK_F11, null));
        this.add(new KeyPosition(bnk, 13, CF, 510, 27 , 
            new Rectangle(510, 27 , 29 , 29), KeyEvent.VK_F12, null));
        this.add(new KeyPosition(bnk, 14, CF, 76 , 73 , 
            new Rectangle(76 , 73 , 29 , 29),KeyEvent.VK_BACK_QUOTE, null));
        ...
        this.add(new KeyPosition(bnk, 16, CF, 138, 73 , 
            new Rectangle(138, 73 , 29 , 29), KeyEvent.VK_2, null));
        ...
        this.add(new KeyPosition(bnk, 18, CF, 200, 73 , 
            new Rectangle(200, 73 , 29 , 29), KeyEvent.VK_4, null));
        ...
        this.add(new KeyPosition(bnk, 24, CF, 386, 73 , 
            new Rectangle(386, 73 , 29 , 29), KeyEvent.VK_0, null));
        ...
        this.add(new KeyPosition(bnk, 28, CF, 76 , 104, 
            new Rectangle(76 , 104, 45 , 29), KeyEvent.VK_TAB, null));
        this.add(new KeyPosition(bnk, 29, CF, 123, 104, 
            new Rectangle(123, 104, 29 , 29), KeyEvent.VK_Q, null));
        ...
        this.add(new KeyPosition(bnk, 32, CF, 216, 104, 
            new Rectangle(216, 104, 29 , 29), KeyEvent.VK_R, null));
        ...
        this.add(new KeyPosition(bnk, 36, CF, 340, 104, 
            new Rectangle(340, 104, 29 , 29), KeyEvent.VK_I, null));
        ...
        this.add(new KeyPosition(bnk, 38, CF, 402, 104, 
            new Rectangle(402, 104, 29 , 29), KeyEvent.VK_P, null));
        ...
        this.add(new KeyPosition(bnk, 42, CF, 76 , 135, 
            new Rectangle(76 , 135, 53 , 29), KeyEvent.VK_TAB, null));
        ...
        this.add(new KeyPosition(bnk, 55, CF, 76 , 166, 
            new Rectangle(76 , 166, 69 , 29), KeyEvent.VK_SHIFT, null));
        ...
        this.add(new KeyPosition(bnk, 64, CF, 395, 166, 
            new Rectangle(395, 166, 29 , 29), KeyEvent.VK_PERIOD, null));
        this.add(new KeyPosition(bnk, 65, CF, 426, 166, 
            new Rectangle(426, 166, 29 , 29), KeyEvent.VK_SLASH, null));
        this.add(new KeyPosition(bnk, 66, CF, 457, 166, 
            new Rectangle(457, 166, 82 , 29), KeyEvent.VK_SHIFT, null));
        this.add(new KeyPosition(bnk, 67, CF, 76 , 197, 
            new Rectangle(76 , 197, 35 , 29), KeyEvent.VK_CONTROL, null));
        this.add(new KeyPosition(bnk, 68, CF, 113, 197, 
            new Rectangle(113, 197, 35 , 29), KeyEvent.VK_WINDOWS, null));
        this.add(new KeyPosition(bnk, 69, CF, 150, 197, 
            new Rectangle(150, 197, 35 , 29), KeyEvent.VK_ALT, null));
        this.add(new KeyPosition(bnk, 70, CF, 187, 197, 
            new Rectangle(187, 197, 204 , 29), KeyEvent.VK_SPACE, null));
        this.add(new KeyPosition(bnk, 71, CF, 393, 197, 
            new Rectangle(393, 197, 35 , 29), KeyEvent.VK_ALT, null));
        ...
        this.add(new KeyPosition(bnk, 73, CF, 467, 197, 
            new Rectangle(467, 197, 35 , 29), KeyEvent.VK_WINDOWS, null));
        this.add(new KeyPosition(bnk, 74, CF, 504, 197, 
            new Rectangle(504, 197, 35 , 29), KeyEvent.VK_CONTROL, null));
    } 
